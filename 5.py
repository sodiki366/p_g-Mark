...
import sys
pygame.init()
#Добавить звуки, при отскоке от ракетки ускариваятся скорость,ограничить скорость до 30,
#добавить табло со скоростью,
size = (1280, 720)
...
SCREEN_HEIGHT // 2 , PADDLE_WIDTH, PADDLE_HEIGHT)
...
while running:
    ...
    if ball_rect.top <= 0 or ball_rect.bottom >= SCREEN_HEIGHT:
        BALL_SPEED_Y *= -1
# Если поверхность мяча столкнулась с поверхностью 1 ракетки или поверхность мяча столкнулась с поверхностью 2 ракетки:
#скорость мяча по оси x умножить на единицу
